...
module.exports = {
    ...
    goTo4Faq: function goTo4Faq(tg, callbackQuery) {
        var text = '<b> Как озонированное масло влияет на поры кожи? Бытует мнение, что при использовании любых косметических масел поры на коже сильно забиваются. Большинство косметологов запрещают пользоваться маслом. Кроме того, в масле могут размножаться бактерии...</b>\n' + '\n' + 'Озонированное масло по лицу используют ограниченно, локально, как правило, с лечебными целями. Для ухода за лицом следует использовать озоновые крема. Занести бактерии с озоновой косметикой (и озонированным маслом) невозможно, в ней они не выживут, поскольку такая ' + 'косметика быстро подавляет любые вирусы и бактерии за счет того, что кислород является губительной средой для них. Более того, озоновую косметику успешно применяют для борьбы с бактериальной и вирусной инфекцией на коже и слизистых.';
