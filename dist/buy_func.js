...
module.exports = {
    ...
    buyMiniBox1: function buyMiniBox1(tg, callbackQuery) {
        ...
        var text = '<b>MiniOzoneBox#1</b>\n' + 'Восстановление волос' + '\n' + '\n' + '<b>В комплекс входит:\n</b>' + '• Маска для восстановления волос PV 1000' + '\n' + '• Озонированное оливковое масло ОТРИ 6000' + '\n' + '\n' + '<b>2100 руб</b>' + '\n' + '\n' + 'Чтобы купить минибокс <b>Восстановление волос</b>, закажи обратный звонок, для этого воспользуйся кнопкой  🔸<b> Заказать звонок</b>  внизу на клавиатуре 👇 \n' + '( если она скрыта, нажми значок  в конце поля для набора текста )' + ' и оставь свой номер.\n' + '\n' + 'Мы обязательно перезвоним  в течение часа! 👌' + '\n' + '\n' + 'Чтобы уточнить детали заказа, отправь в чат сообщение вида <b>КУПИТЬ  XXX</b>, где вместо <b>XXX</b> напиши свое сообщение нашему менеджеру. ';
